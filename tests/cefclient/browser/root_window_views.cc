...
void RootWindowViews::Init(RootWindow::Delegate* delegate,
  ...
  InitOnUIThread(settings, config.url, delegate_->GetRequestContext(this,false));
}
...
void RootWindowViews::InitAsTool(RootWindow::Delegate* delegate, 
    bool bOSR,
    bool bTopMost,
    bool bToolWnd,
...
void RootWindowViews::InitOnUIThread(const CefBrowserSettings& settings,
