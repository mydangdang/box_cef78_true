...
class ClientHandler : public CefClient,
 ...
 public:
  ...
  class Delegate {
   public:
    ...
    virtual void OnBrowserNavigate(CefRefPtr<CefBrowser> browser, std::string sTag, std::string szURL) {}
  ...
  void SetGroupTag(std::string szGroup) {
      sGroup = szGroup;
  }
 ...
 private:
  ...
  void NotifyBrowserNavigate(CefRefPtr<CefBrowser> browser, std::string szTag, std::string szURL);
