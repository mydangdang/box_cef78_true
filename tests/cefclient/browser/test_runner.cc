...
#include "tests/cefclient/logic/WndOpt.h"
#include "tests/cefclient/logic/WebOpt.h"
...
CefRefPtr<CefDictionaryValue> ParseJSON(const CefString& string)
{
...
bool VerifyKey(CefRefPtr<CefDictionaryValue> dictionary, const char* key, cef_value_type_t value_type, CefRefPtr<CefMessageRouterBrowserSide::Callback> callback)
{
...
void CreateMessageHandlers(MessageHandlerSet& handlers) {
    ...
    WndOpt::CreateMessageHandlers(handlers);
    WebOpt::CreateMessageHandlers(handlers);
